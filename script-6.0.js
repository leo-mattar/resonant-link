...
// // --- RESOURCE BACK LINK
// let resourceBackLink = document.querySelector(".c-rc-back-link");
// if (resourceBackLink) {
//   resourceBackLink.addEventListener("click", function (e) {
//     e.preventDefault();
//     window.history.back();
//   });
// }
  ...
  resourceBackLink.addEventListener("click", function (e) {
    ...
    setTimeout(function () {
      if (window.location.pathname === currentPath) {
        window.location.href = "https://www.resonant-link.com/library";
      }
    }, 100);
  });
}
